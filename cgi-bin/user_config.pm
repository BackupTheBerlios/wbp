...
$MSG = {
    ...
    pass_error2		=> "... Bestätigung stimmen nicht überein",
    ...
    mail_error		=> "Das Format der eMail-Adresse ist ungültig ...",
    ...
    # Buttons
    b_anlegen		=> "anlegen",
    b_uebernehmen	=> "übernehmen",
    b_suchen		=> "suchen",
    
    # Tabellenköpfe bzw. Feldbezeichner
    firstname_		=> "Vorname",
    lastname_		=> "Nachname",
    desc_		=> "Beschreibung",
    mail_		=> "eMail-Adresse",
